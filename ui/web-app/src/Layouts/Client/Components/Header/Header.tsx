  ...
  return (
    <>
      <header>
        ...
        <div className="bg-oranges-orange2 gap-3 h-16 flex items-center justify-between px-7">
          <img src={Logo} className="w-50 h-10" />
          <div className="flex-grow">
            <ListCategoryHeader />
          </div>
          <div className="flex-grow flex justify-center">
            <div className="flex w-[550px] rounded bg-white">
              <input
                className="w-full border-none bg-transparent px-3 py-1 text-gray-400 outline-none"
                type="search"
                name="search"
                placeholder="Search..."
              />
          ...
          <button className="gap-3 px-3 flex justify-center items-center bg-white h-8 w-50 rounded">
            <IcEdit />
            Đăng tin
          </button>
        </div>
